...
В данной работе LSH используется в сочетании с MinHash для приближённой оценки Jaccard similarity между документами. 

  
Документы представляются в виде набора k-шинглов (подстрок или последовательностей слов).  
